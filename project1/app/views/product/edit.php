...
<form method="POST" action="/project1/Product/update" onsubmit="return validateForm();" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="image">Ảnh sản phẩm hiện tại:</label><br>
        <?php if (!empty($product->image_url)): ?>
            <img src="/project1/<?php echo htmlspecialchars($product->image_url, ENT_QUOTES, 'UTF-8'); ?>" alt="Ảnh sản phẩm" style="max-width: 200px; max-height: 200px; margin-bottom: 10px;">
        <?php else: ?>
            <p>Không có ảnh.</p>
        <?php endif; ?>
        <br>
